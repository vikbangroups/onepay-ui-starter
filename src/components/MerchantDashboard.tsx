 ...
 * Merchant-specific dashboard with business metrics
...
const MerchantDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (user) {
          mockService.setCurrentUser(String(user.id) || 'merchant-001', user.role || 'merchant');
        }
        
        // Fetch all data in parallel - pass userId and role for merchant-specific data
  ...
  return (
    <div className="dashboard fade-slide-in-up" style={{ backgroundColor: '#f8f9fa', minHeight: '100vh', padding: 'var(--space-6)' }}>
      ...
      <div className="dashboard-section" style={{ marginBottom: 'var(--space-8)' }}>
        <div className="dashboard-header" style={{ 
          ...
          <div style={{ flex: 1, minWidth: '200px' }}>
            <h1 className="dashboard-title" style={{ color: 'white', margin: '0 0 var(--space-2) 0' }}>🏪 Merchant Dashboard</h1>
            <p className="dashboard-subtitle" style={{ color: '#e0e7ff', margin: 0 }}>Manage your business and transactions</p>
          </div>
      ...
      {/* KPI Cards - Merchant Specific */}
      <div className="dashboard-section" style={{ marginBottom: 'var(--space-8)' }}>
        <h3 style={{ fontSize: 'var(--font-size-lg)', fontWeight: '600', color: '#1f2937', marginBottom: 'var(--space-4)', marginTop: 0 }}>📊 Business Metrics</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 'var(--space-5)', gridAutoRows: '1fr' }}>
          ...
          <div 
            ...
            onClick={() => logger.info('Wallet balance clicked')}
          >
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <p style={{ margin: 'var(--space-2) 0 0 0', fontSize: 'var(--font-size-xs)', opacity: 0.85 }}>Available for payout</p>
            </div>
          </div>
      ...
      <div className="premium-card" style={{ backgroundColor: 'linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%)', borderLeft: '4px solid var(--color-info)', boxShadow: 'var(--shadow-md)' }}>
        <h3 className="section-title" style={{ color: 'var(--color-info)', marginTop: 0, marginBottom: 'var(--space-4)' }}>ℹ️ Merchant Status</h3>
        <div style={{ marginTop: 'var(--space-4)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--space-6)' }}>
          <div style={{ padding: 'var(--space-4)', backgroundColor: 'rgba(255, 255, 255, 0.7)', borderRadius: 'var(--radius-lg)' }}><p className="body-small" style={{ margin: 0, marginBottom: 'var(--space-2)', color: '#0369a1', fontWeight: '600', fontSize: 'var(--font-size-xs)', textTransform: 'uppercase' }}>🔐 KYC Status</p><p style={{ margin: 0, fontSize: 'var(--font-size-md)', fontWeight: '500', color: '#1f2937', textTransform: 'capitalize' }}>Verified</p></div>
